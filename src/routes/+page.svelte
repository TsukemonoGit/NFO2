<script lang="ts">
  ...
  import { Check, Triangle } from "@lucide/svelte";
...
{#if latestKind3.value}
  <div class="flex items-center">
    ...
    >
      <Select.Trigger
        class="h-input rounded-md border-border-input bg-background data-placeholder:text-foreground-alt/50 inline-flex w-[296px] touch-none select-none items-center border p-1 my-2 text-sm transition-colors"
